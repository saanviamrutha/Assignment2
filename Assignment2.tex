...
\text Evaluate :
\begin{align}
\int \frac{x\brak{1+x^2}}{1+x^4}dx \nonumber
\end{align}
\solution \\
Let 
\begin{align}
...
\label{eq:eq3}
&=\frac{1}{2}\taninv(t)+\frac{1}{2}\int \frac{t}{1+t^2}dt+C_1
\end{align}
\begin{align}
...
\begin{align}
\int \frac{x\brak{1+x^2}}{1+x^4}dx=\frac{1}{2}\taninv(x^2)+\frac{1}{4}\ln\brak{1+x^4}
\end{align}
\end{document}
